...
- Developed an IoT-based Android app automating school dismissal using GPS tracking.
- Integrated Text-to-Speech (TTS) functionality and digital display systems to provide real-time student pickup updates.
- Improved safety, reduced congestion, and enhanced school–parent communication.
- **Tech:** Flutter, Android Studio, Firebase, GPS API, Text-to-Speech (TTS)
- 🔗 https://github.com/mashael-qq1/AutoCaller

**PeekABoo** (SWE444)
- Built a mobile app for daycare management with caregiver browsing and session scheduling.
...
- Contributed statistical summaries & documentation.
